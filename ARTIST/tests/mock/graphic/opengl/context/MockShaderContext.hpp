...
namespace artist::mock::graphic::opengl::context
{
    ...
    class MockShaderContext : public artist::graphic::context::ShaderContext<graphic::api::MockOpenGL>
    {
    public:
        ...
        MOCK_METHOD(void, setShaderType, (artist::graphic::context::ShaderType shaderType), (override));
        MOCK_METHOD(artist::graphic::context::ShaderType, getShaderType, (), (const, override));
