...
using MockShader = artist::mock::graphic::pipeline::MockShader<api::OpenGL>;
...
TEST_F(PassFreerTests, FreePassTest_validContext)
{
    ...
    auto *shader1 = new MockShader("shader_path", artist::graphic::context::ShaderType::VERTEX);
    delete shader1;
    auto shader = std::make_shared<MockShader>("shader_path", artist::graphic::context::ShaderType::VERTEX);
