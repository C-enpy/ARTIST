...
namespace profile = artist::graphic::opengl::profile;
...
TEST_F(PassTest, InvalidUniformTest)
{
    ...
    EXPECT_THROW(pass.withUniform("nonExistentUniform", 5), artist::common::exception::TraceableException<std::runtime_error>);
}
